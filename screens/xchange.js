    ...
    >
      ...
      <View style={styles.cardContent}>
        <Text style={styles.cardPrice}>
          {item.currency} {parseFloat(item.selling_price).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        </Text>
    ...
    <>
      <View style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
        ...
        <View style={styles.sectionRow}>
          <Text style={styles.sectionTitle}>The Xchange</Text>
          <TouchableOpacity style={styles.sectionTitle}>
            <Icon name="notifications-outline" size={26} color="#b48c5a" />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.sectionRo}>
          <Text style={styles.section}>Daily Discovery</Text>
          <TouchableOpacity
            style={{
              flexDirection: 'row',
              alignItems: 'center',
          ...
          >
            ...
            <Icon name="options-outline" size={20} color="#b48c5a" style={{ marginLeft: 4 }} />
          </TouchableOpacity>
        </View>
      ...
      <View style={{
        ...
        {/* Paste the footer code here, before the closing </View> */}
        <View style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: 70, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#ddd', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', elevation: 10 }}>
          {/* Xhibit */}
          <TouchableOpacity style={{ alignItems: 'center', flex: 1 }}>
            <Icon name="albums-outline" size={24} color="#888" />
            <Text style={{ fontSize: 12, color: '#888', marginTop: 4 }}>Xhibit</Text>
          </TouchableOpacity>
          {/* Xchange (active) */}
          <TouchableOpacity style={{ alignItems: 'center', flex: 1 }}>
            <Icon name="storefront-outline" size={24} color="#b48c5a" />
            <Text style={{ fontSize: 12, color: '#b48c5a', marginTop: 4 }}>Xchange</Text>
          </TouchableOpacity>
          {/* Floating XURE button */}
          <View style={{
            position: 'absolute',
            top: -30,
            left: '50%',
            ...
            <Text style={{ color: '#b48c5a', fontWeight: 'bold', fontSize: 18 }}>XURE</Text>
          </View>
          {/* Inventory */}
          <TouchableOpacity style={{ alignItems: 'center', flex: 1 }}>
            <Icon name="library-outline" size={24} color="#888" />
            <Text style={{ fontSize: 12, color: '#888', marginTop: 4 }}>Inventory</Text>
          </TouchableOpacity>
          {/* Profile */}
          <TouchableOpacity style={{ alignItems: 'center', flex: 1 }}>
            <Icon name="person-outline" size={24} color="#888" />
            <Text style={{ fontSize: 12, color: '#888', marginTop: 4 }}>Profile</Text>
          </TouchableOpacity>
        </View>
      </View>
    </>
